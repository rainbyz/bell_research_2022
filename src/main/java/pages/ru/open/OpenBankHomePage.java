...
public class OpenBankHomePage extends BasePage {
    ...
    public OpenBankHomePage(WebDriver currentDriver) {
        super(currentDriver);
        mWait = new WebDriverWait(currentDriver, Duration.ofSeconds(60));
    }

    public WebElement getCurrencyTable() {
        mWait.until(ExpectedConditions.visibilityOfElementLocated(currencyTableLocator));
        return driver.findElement(currencyTableLocator);
    }
